          ...
          <section className="flex min-h-[680px] flex-col justify-center p-7 sm:p-10">
            <div className="mx-auto w-full max-w-[390px]">
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <button type="submit" disabled={busy} className="w-full rounded-xl bg-primary px-4 py-3 text-sm font-bold tracking-wide disabled:opacity-50">{registering ? "CREATE ACCOUNT" : "SIGN IN"}</button>
              </form>
